...
import { Award, BookOpen, Globe, Star, TrendingUp, Users } from 'lucide-react'
      ...
      <div className="container relative mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ...
            {' '}
            <span className="text-foreground">در یک نگاه</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            اعداد و ارقامی که نشان‌دهنده تعهد ما به ارائه بهترین تجربه مطالعه است
          </p>
        </motion.div>
